#!/usr/bin/env python3
"""Stage 5: Implement - implements plan with verification.

Usage: stage_5_implement_plan.py 'objective' --plan-doc PATH [--session-id ID]
...
def _parse_args() -> tuple[str, str, str | None]:
    ...
    return objective, plan_doc, session_id
...
def main() -> None:
    ...
    objective, plan_doc, session_id = _parse_args()
