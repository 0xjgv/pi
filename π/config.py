"""Configuration for π workflow module.

This module provides agent options and command mapping for the SDK-based
...
def setup_logging(log_dir: Path, *, verbose: bool = False) -> Path:
    ...
    pi_logger.addHandler(file_handler)
    ...
    if verbose:
        ...
        pi_logger.addHandler(console_handler)
