...
class Workflow:
    research_codebase: Callable[..., str]
    implement_plan: Callable[..., str]
    create_plan: Callable[..., str]


def build_workflow(*, logger: Logger, console: Console) -> Workflow:
    ...
    def create_plan(
        *,
        ...
        try:
            ...
            _get_session().set_doc_path(
                Command.CREATE_PLAN, str(research_document_path)
            )
